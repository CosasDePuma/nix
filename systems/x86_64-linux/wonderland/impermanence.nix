_: { config, lib, ... }: {   # TODO(improvement): Create a real impermanence module
  systemd.tmpfiles.rules = lib.flatten (
    # --- oci-container volumes ---
    (lib.mapAttrsToList (_: container:
      builtins.map (volume:
        lib.optional (lib.hasPrefix "/persist" volume) 
    ...
    (lib.mapAttrsToList (_: container:
      lib.mapAttrsToList (_: mount:
        lib.optional (lib.hasPrefix "/persist" mount.hostPath) 
